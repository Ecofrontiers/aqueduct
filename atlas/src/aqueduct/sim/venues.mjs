...
export const TO_BUILD_PLATFORM_NODES = [
  { name: "Algrano", kind: "coffee marketplace", status: "TO-BUILD", note: "priority 2 connector — cleanest scrapeable coffee marketplace (research/05)" },
  { name: "Agrotoken", kind: "onchain grain index tokens", status: "TO-BUILD", note: "priority 3 connector — not smallholder-granular" },
  { name: "Beyco", kind: "coffee traceability platform", status: "TO-BUILD", note: "deprioritized (research/05)" },
  { name: "DeHaat", kind: "agri-input + output platform", status: "TO-BUILD", note: "closed-by-design (research/05) — node only, never live-integrated" },
  { name: "Farmer Connect", kind: "traceability platform", status: "TO-BUILD", note: "dormant (research/05) — node only, never live-integrated" },
  { name: "WFP Building Blocks", kind: "humanitarian blockchain cash transfer", status: "TO-BUILD", note: "closed-by-design — node only" },
];
